		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Modifica tratta</div>
								...
								<form id="form_PopUp">
									<div class="form-group">
										<label>Ora</label> <select id="hour">
											...
											<option>19</option>
											<option>20</option>
										</select > <label>Minuti</label> <select id="minute">
											<option>01</option>
											<option>02</option>
											<option>03</option>
											<option>04</option>
									...
									<div class="form-group">
										...
										</select> <label>Stato</label> <select id="stato">
									...
									<div class="form-group">
										<label>Note</label>
										<textarea id="textNote" name="textNote" class="form-control" rows="3"></textarea>
									</div>
